...
class GlobalExceptionHandlerTest {
  ...
  void testHandleValidationExceptions() throws Exception {
    ...
    when(exception.getBindingResult().getFieldErrors()).thenReturn(
  ...
  void testErrorResponseWithDetails() {
    ...
    GlobalExceptionHandler.ErrorResponse errorResponse =
        new GlobalExceptionHandler.ErrorResponse(ErrorEnum.DADOS_INVALIDOS, "Mensagem",
  ...
  void testErrorResponseWithoutDetails() {
    GlobalExceptionHandler.ErrorResponse errorResponse =
        new GlobalExceptionHandler.ErrorResponse(ErrorEnum.ERRO_INTERNO, "Mensagem",
            LocalDateTime.now());
