...
class ClienteControllerTest {
    ...
    void atualizar_DeveRetornarClienteAtualizado() {
        when(clienteHandler.atualizar(any(ClienteRequestDTO.class), anyLong())).thenReturn(clienteResponseDTO);

        ResponseEntity<ClienteResponseDTO> response = clienteController.atualizar(1L, clienteRequestDTO);
